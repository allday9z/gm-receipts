...
4. ลบโค้ดตัวอย่างที่มีอยู่ทั้งหมดในไฟล์ `Code.gs` แล้ว copy โค้ดทั้งหมดจากไฟล์ `Code.gs` ในโฟลเดอร์นี้ไปวางแทน
   - 💡 ถ้าเปิดไฟล์นี้ผ่านมือถือ แนะนำให้กดปุ่ม **Raw** บนหน้า GitHub ก่อน แล้วกด **select all / เลือกทั้งหมด** (อย่าลากเลือกด้วยนิ้วเอง เพราะถ้ามีบรรทัดยาวเกินจอ อาจโดนตัดตอนจบบรรทัดหายไปโดยไม่รู้ตัว แล้วจะ error แบบ "missing ) after argument list")
   - ถ้าทำบนคอมได้จะปลอดภัยกว่า
